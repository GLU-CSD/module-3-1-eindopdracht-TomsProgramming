...
<head>
    ...
    <link rel="stylesheet" href="assets/css/cart.css?v=<?php echo filemtime('assets/css/cart.css') ?>">
    <script src="https://kit.fontawesome.com/0fa38cfac4.js" crossorigin="anonymous" defer></script>
    <script src="assets/js/cart.js?v=<?php echo filemtime('assets/js/cart.js') ?>" defer></script>
</head>
    ...
    <main>
        ...
        <div class="emptyCartContainer">
            <div class="empty">
                ...
                <a href="/" class="cta-button">Bekijk producten</a>
            </div>
        </div>
        <div class="cartContainer">
            ...
            <div class="cartCheckout">
                ...
                <div class="cost">
                    <table>
                        <tr>
                            <td class="costName">Artikelen (<span class="totalProducts">0</span>)</td>
                            <td class="costPrice">&euro; <span class="totalProductsPrices">0,00</span></td>
                        </tr>
                        <tr>
                            <td class="costName">Verzendkosten</td>
                            <td class="costPrice">&euro; 0,00</td>
                        </tr>
                        <tr>
                            <td colspan="2"><hr></td>
                        </tr>
                        <tr>
                            ...
                            <td class="costPrice totalPrice">&euro; <span class="totalPriceSpan">0,00</span></td>
                        </tr>
                    </table>
                </div>
